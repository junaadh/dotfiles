...
nmap("n", "<leader>%", ":lua require(\"custom.io\").createFile()<CR>", opts)
nmap("n", "<leader>d", ":lua require(\"custom.io\").createDir()<CR>", opts)
nmap("n", "<leader>$", ":lua require(\"custom.io\").rename()<CR>", opts)
...
nmap("n", "<C-c>", ":lua require(\"custom.comments\").comment()<CR>", opts)
-- TODO: work in progress
nmap("x", "<C-c>", ":lua require(\"custom.comments\").comment()<CR>", opts)
