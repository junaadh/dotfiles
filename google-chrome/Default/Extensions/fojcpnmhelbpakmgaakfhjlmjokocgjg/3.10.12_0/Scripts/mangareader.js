function mangareaderF() {
    ...
    if(document.querySelector("table.d48") !== null){
        chapterList = document.querySelector("table.d48");
    ...
    function addNote(){
        let chapterDiv = document.querySelector("table.d48");
            ...
            xhttp.onreadystatechange = function () {
                ...
                if (this.readyState === 4 && this.status === 200) {
                    ...
                    for(let scr of scripts){
                        ...
                        if(script.includes("document[\"mj\"]")){
                            exist = true;
                            break;
                        }
                    }
                    ...
                    let str = script.slice(startIndex, script.length);
                    let chapterData = JSON.parse(str);
                    let imagesData = chapterData.im;
