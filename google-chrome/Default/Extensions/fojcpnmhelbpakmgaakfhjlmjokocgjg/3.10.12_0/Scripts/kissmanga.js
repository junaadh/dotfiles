...
function kissmangaF() {
    ...
    function addNote(){
        ...
        note.innerHTML = "<p style=\"color: red;font-weight: bold;\">(Manga Downloader)</p>"
                            +"<span style=\"color: red;font-weight: bold;\">Download</span> buttons are inside each chapter page on top";
