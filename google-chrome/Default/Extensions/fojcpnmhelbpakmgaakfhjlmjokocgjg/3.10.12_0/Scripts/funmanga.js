function funmangaF() {
    ...
    if(document.querySelector("div.manga-info div#chapter_list") !== null){
        rows = document.querySelectorAll("div.manga-info div#chapter_list ul.chapter-list li");
        // calling function
        addNote();
        addBatchDownload();
        addDownloadButtons();
    ...
    function addNote(){
        let chapterDiv = document.querySelector("div#chapter_list");
    ...
    function addDownloadButtons(){
        for (let i=0;i<rows.length;i++) {
            ...
            // store chapter link
            links[i] = rows[i].querySelector("a").href + "/all-pages";
            pdfButton.referrerLink = "https://www.funmanga.com/";
            
            pdfButton.title = rows[i].querySelector("a span.val").textContent.trim();
            ...
            xhttp.onreadystatechange = function () {
                ...
                if (this.readyState === 4 && this.status === 200) {
                    ...
                    let imgs = doc.querySelectorAll("div.content-inner img.img-responsive");
